...
var Pagination = (function (_super) {
  ...
  function Pagination(props) {
    ...
    _this.handleMoveLeft = function (evt) {
      evt.preventDefault();
      var n = resources.area ? _this.page - _this.max * 2 - 1 : _this.page - 1;
      _this.gotoPage(n);
    };
  ...
  Pagination.prototype.render = function () {
    ...
    return (React.createElement(react_1.Fragment, null, React.createElement('nav', { className: this.props.className, 'aria-label': 'Countries Pagination' }, React.createElement('ul', { className: 'pagination' }, pages.map(function (page, index) {
      if (page === LEFT_PAGE) {
        return (React.createElement('li', { key: index, className: 'page-item left' }, React.createElement('a', { className: 'page-link', 'aria-label': 'Previous', onClick: x.handleMoveLeft }, React.createElement('span', { 'aria-hidden': 'true' }, '\u00AB'), React.createElement('span', { className: 'sr-only' }, 'Previous'))));
      }
      if (page === RIGHT_PAGE) {
        return (React.createElement('li', { key: index, className: 'page-item right' }, React.createElement('a', { className: 'page-link', 'aria-label': 'Next', onClick: x.handleMoveRight }, React.createElement('span', { 'aria-hidden': 'true' }, '\u00BB'), React.createElement('span', { className: 'sr-only' }, 'Next'))));
      }
